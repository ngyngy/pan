...
<body>
  <div class="container">
    ...
    <article class="card">
      ...
      <!-- Twitter / 𝕏 APP 内置浏览器专属安全提示 (通过 UA 智能侦测唤出) -->
      <div id="twitterAppTip" style="display:none; margin-bottom:18px; background:#fffbeb; border:1.5px solid #f59e0b; border-radius:12px; padding:12px 16px; color:#92400e; font-size:13px; line-height:1.5;">
        <div style="display:flex; align-items:flex-start; gap:10px;">
          ...
          <div>
            ...
            <span>检测到您在 <strong>推特 / 𝕏 APP 内置浏览器</strong> 中访问。为防止推特内置 Webview 拦截外部网盘，建议点击下方<strong>【打开夸克 App】</strong>一键转存，或点击<strong>【复制夸克链接】</strong>后切换至手机 Safari / Chrome 浏览器打开！</span>
          </div>
        </div>
      </div>
...
${escapeHtml(res.recommendation)}
  ...
  <script>
    ...
    // 智能识别客户端访问环境：Twitter 环境专属指引与电脑端备用提示
